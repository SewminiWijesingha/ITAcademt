                        ...
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="classRegister.php" method="post">
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Subject Name</label>
                                            <input type="text" class="form-control" name="subjectname" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                        ...
                                        <button type="submit" name="subRegister" class="btn btn-primary mt-3">Register</button>
                                    </form>
