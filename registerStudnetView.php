        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Register Students</h1>
                </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card" style="width: 100%;">
                                <img src="Assets/Img/regStd.jpg" class="img" alt="reg">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card p-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="registerStudent.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="tel" class="form-control" name="Whatsapp" id="exampleInputPassword1">
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" min="6" max="13" name="grade" class="form-control" id="exampleInputPassword1">
                                            </div>

                                            <div class="mb-3">
                                                <label for="exampleInputPassword1" class="form-label">Fee</label>
                                                <input type="number" name="fee" class="form-control" id="exampleInputPassword1">
                                            </div>
