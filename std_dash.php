        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3 sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="std_paymentHistoryView.php">
                ...
                <div class="row mb-3">
                    <div class="col-2">
                        <div class="card bg-primary">
                            <div class="card-body">
                                <p class="text-light"> Number Notes </p>

                                <?php
                                include('connection.php');

                                $query = "SELECT note_id FROM upload ORDER BY note_id";
                                $query_run = mysqli_query($conn, $query);
                                $Row = mysqli_num_rows($query_run);
                                echo '<h1 class="text-light">  ' . $Row . '</h1>'
                                ?>
                                        ...
                                        if (mysqli_num_rows($query_run) > 0) {
                                            ...
                                            while ($row = mysqli_fetch_assoc($query_run)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a download href="uploads/<?php echo $row ['filename']; ?>">Download Here</a> </td>
